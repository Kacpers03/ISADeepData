...
export const apiService = {
  ...
  async getContractorAreasGeoJson(contractorId: number, params: {
    locationId?: string;
  } = {}): Promise<any> {
    try {
      let queryString = '';
  ...
  async getBlockAnalytics(blockId: number, params: {
    locationId?: string;
  } = {}): Promise<any> {
    try {
      let queryString = '';
  ...
  async getContractorSummary(contractorId: number, params: {
    locationId?: string;
  } = {}): Promise<any> {
    try {
      let queryString = '';
