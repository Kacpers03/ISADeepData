...
export default function MapPage() {
  ...
  <p>
    {t('map.infoCards.explore.description') || "Use the search function to quickly find contractors, areas, blocks, and stations. Click on markers for detailed information."}
  </p>
</div>
...
<div className={styles.infoCard}>
  ...
  <p>
    {t('map.infoCards.resources.description') || "The ISA regulates exploration of minerals in the international seabed area, which covers approximately 54% of the world's oceans."}
  </p>
</div>
...
<div className={styles.infoCard}>
  ...
  <p>
    {t('map.infoCards.transparency.description') || "All contract information is available as part of ISA's commitment to transparency in deep seabed activities and environmental protection."}
  </p>
</div>
        </div>
      </div>
