	...
	const approachBooths = [
		{
			...
			description: 'Regional Environmental Management Plans for different areas of the seabed',
			image: '../image/emp.jpg',
		...
		},
		{
			...
			description: 'Guidelines and procedures for assessing potential environmental impacts',
			image: '../image/eia.jpg',
		...
		},
		{
			...
			description: 'Areas set aside for monitoring the environmental impacts of activities in the Area',
				...
				<div className={styles.textBlock}>
					...
					<div className={styles.features}>
						...
						<div className={styles.feature}>
							...
							<p>Evaluating potential impacts of deep-seabed activities through scientific research and monitoring</p>
						</div>
						<div className={styles.feature}>
