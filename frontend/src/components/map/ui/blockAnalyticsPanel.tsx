  ...
  return (
    <div className={styles.detailPanel}>
      ...
      <div className={styles.detailHeader}>
        <h3>{safeGet(displayData, 'block.blockName', `Block ${safeGet(displayData, 'block.blockId', '')}`)} Analytics</h3>
      ...
      <div className={styles.detailContent}>
        ...
        <div className={styles.blockBasicInfoGrid}>
          ...
          <div className={styles.infoGroup}>
            ...
            <div className={`${styles.statusBadge} ${
              safeGet(displayData, 'block.status') === 'Active' ? styles.statusActive : 
              safeGet(displayData, 'block.status') === 'Pending' ? styles.statusPending : 
              safeGet(displayData, 'block.status') === 'Reserved' ? styles.statusReserved : 
          ...
          <div className={styles.infoGroup}>
            ...
            <div className={styles.infoValue}>{safeGet(displayData, 'block.area.contractor.contractorName', 'Unknown Contractor')}</div>
          </div>
        ...
        <div className={styles.analyticsSection}>          
          <div className={styles.analyticsCounts}>
            ...
            <div className={styles.analyticsCount}>
              <span className={styles.countValue}>{formatNumber(safeGet(displayData, 'counts.environmentalResults', 0))}</span>
              <span className={styles.countLabel}>Env. Results</span>
            </div>
            <div className={styles.analyticsCount}>
              <span className={styles.countValue}>{formatNumber(safeGet(displayData, 'counts.geologicalResults', 0))}</span>
        ...
        {(!displayData.environmentalParameters || displayData.environmentalParameters.length === 0) &&
         ...
         (!displayData.recentStations || displayData.recentStations.length === 0) && (
          <div className={styles.infoMessage}>
            <p>This block contains stations based on geographic coordinates but they are not formally associated in the database.</p>
